...
log("CCNS v11.11 loaded (HOTKEY-ONLY: Ctrl+Shift+H toggles the search panel; open gated to the Hair/Head picker via one on-demand walk; no Tick heartbeat, no auto-open, no per-tick logging; labels + mod-of-origin; on-demand tile numbering; CCNS_Search()/CCNS_Toggle()).")
