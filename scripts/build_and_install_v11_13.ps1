...
$srcDir   = 'C:\Claude Projects\BG3 Mods\CCNS\_v7_work\extracted_v11_13'
$buildPak = 'C:\Claude Projects\BG3 Mods\CCNS\CCNS_ModSourceSpike\CCNS_HairHeadSearch.pak'
$archive  = 'C:\Claude Projects\BG3 Mods\CCNS\Prior Build Paks\CCNS_searchpanel_v11_13_2026-07-05.pak'
$cFolder  = 'C:\Claude Projects\BG3 Mods\CCNS\CCNS_HairHeadSearch_v11_13.pak'
...
# --- 1. XAML fidelity (v11.13 is Lua-only; XAML byte-identical to v11.12 / v11.9 baseline) ---
...
# --- 2. meta.lsx author guard (unchanged from v11.12) ---
...
foreach ($t in 'HOTKEY-ONLY','v11.13 loaded','togglePanel','Ext.Events.KeyInput','Ext.Events.StatsLoaded','vanilla tiles are numbered too') {
...
# --- 3b. NEGATIVE tokens (heartbeat gone; old modded-only gate removed) ---
foreach ($t in 'Ext.Events.Tick','GameStateChanged:Subscribe','autoTick','CCNS_ProbeBaseline','modded-only; nil = base/vanilla -> skip','v11.12 loaded') {
  $n = (Select-String -LiteralPath $lua -Pattern $t -SimpleMatch -AllMatches | Measure-Object).Count
...
# --- 5. Copies + install (replaces v11.12) ---
